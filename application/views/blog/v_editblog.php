	...
	<div class="panel-body">
		<div class="col-md-6">
			<form role="form">
					...
					<label>Date</label>
						<input type="Date" class="form-control" name="date" placeholder="date" value="<?php echo $key->date ?>"required="required">

					<label>Tittle</label>
						<input type="text" class="form-control" type="text" name="tittle" placeholder="tittle" value="<?php echo $key->tittle ?>"required="required">

					<label>Content</label>
						<textarea class="form-control" rows="3" name="content" placeholder="Content" value="<?php echo $key->content ?>"required="required"></textarea>
